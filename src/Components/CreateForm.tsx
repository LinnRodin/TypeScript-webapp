...
const CreateForm = () => {
  ...
  return (
    <form onSubmit={create} className='d-grid mb-5'>
      ...
      <input value={productRequest.imageURL} onChange={(e) => setProductRequest({...productRequest, imageURL: e.target.value})} type="text" className="form-control py-2 mb-3" placeholder='Enter articlenumber...' />
